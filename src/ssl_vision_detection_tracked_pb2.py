...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='ssl_vision_detection_tracked.proto',
  package='',
  syntax='proto2',
...
_TRACKEDBALL.fields_by_name['pos'].message_type = ssl__gc__geometry__pb2._VECTOR3
_TRACKEDBALL.fields_by_name['vel'].message_type = ssl__gc__geometry__pb2._VECTOR3
_KICKEDBALL.fields_by_name['pos'].message_type = ssl__gc__geometry__pb2._VECTOR2
_KICKEDBALL.fields_by_name['vel'].message_type = ssl__gc__geometry__pb2._VECTOR3
_KICKEDBALL.fields_by_name['stop_pos'].message_type = ssl__gc__geometry__pb2._VECTOR2
_KICKEDBALL.fields_by_name['robot_id'].message_type = ssl__gc__common__pb2._ROBOTID
_TRACKEDROBOT.fields_by_name['robot_id'].message_type = ssl__gc__common__pb2._ROBOTID
_TRACKEDROBOT.fields_by_name['pos'].message_type = ssl__gc__geometry__pb2._VECTOR2
_TRACKEDROBOT.fields_by_name['vel'].message_type = ssl__gc__geometry__pb2._VECTOR2
...
TrackedBall = _reflection.GeneratedProtocolMessageType('TrackedBall', (_message.Message,), dict(
  ...
  __module__ = 'ssl_vision_detection_tracked_pb2'
